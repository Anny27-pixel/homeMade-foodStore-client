...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-orange-200 text-primary-content">
            <div>
                <img style={{ height: '150px' }} src={logo} alt="" />
                <p className="font-bold text-orange-500">
                    Home Made Food Store
                </p>
                <p><small className=" text-orange-500">Copyright © 2022 - All right reserved</small></p>
            </div>
            <div>
